        ...
        <div className="d-flex justify-content-center">
            <div className="container-request d-flex justify-content-between m-2">
                <div className="m-auto w-25 p-2">
                    <img className="p-2 card-pic" src={props.donations.medicine_picture} style={{ height: "130px" }} onError={({currentTarget})=>{
                ...
                <div className="m-auto w-50 p-1">
                    <h5 className="m-2 text-secondary">{props.donations.title}</h5>
                    <div className="d-flex">
                        <div className="m-2">
                        <h6 className="text-secondary">Presentación:</h6>
                        <p className="text-secondary">{props.donations.presentation}</p>
                        </div>
                        <div className="m-2">
                ...
                <div className="m-auto w-25 p-2">
                <button type="button" className="btn btn-secondary text-white fw-bold ">Eliminar Solicitud</button>
                </div>  
            </div>
        </div>
);
